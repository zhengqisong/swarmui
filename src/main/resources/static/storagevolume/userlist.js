$(function() {
	...
	function loadTableData(){
		$.loadTableData({
			...
			"ajax":{
				url:'/api/storagevolume/'+currentCluster.clusterid+'/rights/'+pvolumeid+'/user/list',// 跳转到 action    
			    type:'get',    
			    cache:false,
			    dataType:'json' 
			},
	...
	$('#newUserId').click(function(){
		$.contextLoad('/storagevolume/userrightadd.html?volumeid='+pvolumeid+'&name='+pname);
	});
});